package arch.active.remotedata.retrofit;
...
public class RetrofitHelper {
    ...
    public static <T> T createService(Class<T> service, final String cookie) {
        return newRetrofit(Urls.HOST_URL, cookie).create(service);
    }
